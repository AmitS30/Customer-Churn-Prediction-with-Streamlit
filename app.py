...
st.title('Churn Customer Predictor')
...
if st.button('Predict Probability'):
        ...
        st.header('Chances of customer Staying:-'+str(round(losspro*100))+'%')
        st.header('Chances of customer leaving:-'+str(round(winpro*100))+'%')
